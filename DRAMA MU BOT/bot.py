...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("⭐️ GRUP DRAMA MU OFFICIAL ⭐️", url="https://t.me/dramamuofficial")], # (Ganti URL ini)
        ...
        [InlineKeyboardButton("💬 HUBUNGI KAMI", url="https://t.me/kot_dik")] # (Ganti URL ini)
    ]
